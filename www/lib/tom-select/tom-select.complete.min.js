...
!(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        ? define(t)
        : ((e = "undefined" != typeof globalThis ? globalThis : e || self).TomSelect = t());
})(this, function () {
    "use strict";
    function e(e, t) {
        e.split(/\s+/).forEach((e) => {
    ...
    const A = (e) => {
        ...
        F = (e, t, i) => {
            ...
            return e
                ? ((e += ""),
                  null == t.regex || -1 === (n = e.search(t.regex)) ? 0 : ((s = t.string.length / e.length), 0 === n && (s += 0.5), s * i))
                : 0;
        },
        L = (e, t) => {
            var i = e[t];
    ...
    class P {
        ...
        tokenize(e, t, i) {
            ...
            var o;
            return (
                i && (o = new RegExp("^(" + Object.keys(i).map(r).join("|") + "):(.*)$")),
                n.forEach((e) => {
                    let i,
                        n = null,
                        l = null;
                    o && (i = e.match(o)) && ((n = i[1]), (e = i[2])),
                        e.length > 0 && ((l = this.settings.diacritics ? A(e) || null : r(e)), l && t && (l = "\\b" + l)),
                        s.push({ string: e, regex: l ? new RegExp(l, "iu") : null, field: n });
                }),
                s
            );
        }
        ...
        prepareSearch(e, t) {
            ...
            if ((L(s, "sort"), L(s, "sort_empty"), s.fields)) {
                ...
                const e = [];
                s.fields.forEach((t) => {
                    "string" == typeof t && (t = { field: t, weight: 1 }), e.push(t), (i[t.field] = "weight" in t ? t.weight : 1);
                }),
                    (s.fields = e);
            }
            return {
        ...
        search(e, t) {
            ...
            e.length
                ? E(n.items, (e, n) => {
                      (i = o(e)), (!1 === t.filter || i > 0) && s.items.push({ score: i, id: n });
                  })
                : E(n.items, (e, t) => {
                      ...
                      (p.maxItems = e.hasAttribute("multiple") ? null : 1),
                          N(e.children, (e) => {
                              ...
                              "optgroup" === (t = e.tagName.toLowerCase())
                                  ? (((n = f((i = e)))[a] = n[a] || i.getAttribute("label") || ""),
                                    (n[c] = n[c] || h++),
                                    (n[r] = n[r] || i.disabled),
                                    (n.$order = n.$order || ++g),
                                    p.optgroups.push(n),
    ...
    class de extends (function (e) {
        ...
        setup() {
            ...
            (null === t.maxItems || t.maxItems > 1) && e.is_select_tag && Q(a, { multiple: "multiple" }),
            ...
            se(document, "mousedown", v),
                ...
                (this.revertSettings = { innerHTML: a.innerHTML, tabIndex: a.tabIndex }),
                (a.tabIndex = -1),
                ...
                switch (e.keyCode) {
                    ...
                    case 13:
                        return void (t.canSelect(t.activeOption)
                            ...
                            : ((t.settings.create && t.createItem()) || (document.activeElement == t.control_input && t.isOpen)) && ie(e));
                    case 37:
                    ...
                    case 9:
                        return void (
                            ...
                            (t.canSelect(t.activeOption) && (t.onOptionSelect(e, t.activeOption), ie(e)),
            ...
            this.lastValue !== t &&
                ...
                "" != t
                    ? (this.refreshTimeout && clearTimeout(this.refreshTimeout),
                      (this.refreshTimeout = ((e, t) => (t > 0 ? setTimeout(e, t) : (e.call(null), null)))(() => {
        ...
        onFocus(e) {
            ...
            t.ignoreFocus ||
                ...
                i || t.trigger("focus"),
                t.activeItems.length || (t.inputState(), t.refreshOptions(!!t.settings.openOnFocus)),
                t.refreshState());
        }
        onBlur(e) {
        ...
        setActiveItem(e, t) {
            ...
            if ("single" !== a.settings.mode) {
                ...
                if ("click" === (i = t && t.type.toLowerCase()) && ne("shiftKey", t) && a.activeItems.length) {
                    for (
                        l = a.getLastActive(),
                            (n = Array.prototype.indexOf.call(a.control.children, l)) > (o = Array.prototype.indexOf.call(a.control.children, e)) &&
                                ((r = n), (n = o), (o = r)),
                            s = n;
                        s <= o;
                        s++
        ...
        clearActiveOption() {
            this.activeOption && (R(this.activeOption, "active"), Q(this.activeOption, { "aria-selected": null })),
                (this.activeOption = null),
        ...
        inputState() {
            ...
            e.control.contains(e.control_input) &&
                ...
                e.activeItems.length > 0 || (!e.isFocused && e.settings.hidePlaceholder && e.items.length > 0)
                    ...
                    : (e.settings.hidePlaceholder && e.items.length > 0 && Q(e.control_input, { placeholder: "" }), (e.isInputHidden = !1)),
        ...
        search(e) {
            ...
            return (
                e !== s.lastQuery
                    ? ((s.lastQuery = e), (t = s.sifter.search(e, Object.assign(n, { score: i }))), (s.currentResults = t))
        ...
        refreshOptions(e = !0) {
            ...
            for (t = 0; t < n; t++) {
                ...
                let a = Y(n),
                    d = h.getOption(a, !0);
                for (
                    h.settings.hideSelected || d.classList.toggle("selected", h.items.includes(a)),
            ...
            if (
                (h.loading ? _("loading") : h.settings.shouldLoad.call(h, g) ? 0 === v.items.length && _("no_results") : _("not_loading"),
        ...
        addItem(e, t) {
            te(this, t ? [] : ["change", "dropdown_close"], () => {
                ...
                const n = this,
                    ...
                    r = X(e);
                if (
                    (!r || -1 === n.items.indexOf(r) || ("single" === o && n.close(), "single" !== o && n.settings.duplicates)) &&
                    null !== r &&
        ...
        removeItem(e = null, t) {
            ...
            (s = K(e)),
                e.remove(),
                e.classList.contains("active") && ((n = i.activeItems.indexOf(e)), i.activeItems.splice(n, 1), R(e, "active")),
                i.items.splice(s, 1),
                (i.lastQuery = null),
        ...
        close(e = !0) {
            var t = this,
                i = t.isOpen;
            e && (t.setTextboxValue(), "single" === t.settings.mode && t.items.length && t.inputState()),
                (t.isOpen = !1),
        ...
        deleteSelection(e) {
            var t,
                ...
                r = this;
            (t = e && 8 === e.keyCode ? -1 : 1),
                (i = { start: (o = r.control_input).selectionStart || 0, length: (o.selectionEnd || 0) - (o.selectionStart || 0) });
            const l = [];
                ...
                n.inputValue().length ||
                    (ne(J, t) || ne("shiftKey", t)
                        ? (s = (i = n.getLastActive(e))
                          ...
                          (s.classList.contains("active") && n.removeActiveItem(i), n.setActiveItemClass(s))
                        : n.moveCaret(e));
        }
        moveCaret(e) {}
        getLastActive(e) {
            ...
            if (
                ...
                Q(s, { "data-value": i }),
                    "item" === e
                        ...
                        : (D(s, n.settings.optionClass), Q(s, { role: "option", id: t.$id }), (t.$div = s), (n.options[i] = t));
            }
            return s;
        }
        _render(e, t) {
        ...
        hook(e, t, i) {
            ...
            s[t] = function () {
                ...
                return (
                    ...
                    "instead" === e ? o : ("before" === e && (t = n.apply(s, arguments)), t)
                );
            };
        }
    }
    return (
            ...
            t.hook("after", "setupTemplates", () => {
                ...
                t.hook("instead", "onOptionSelect", (e, s) => {
                    if (s.classList.contains("selected"))
                        return s.classList.remove("selected"), t.removeItem(s.dataset.value), t.refreshOptions(), void ie(e, !0);
                    i.call(t, e, s), o(s);
                });
        }),
        de.define("clear_button", function (e) {
            const t = this,
                i = Object.assign(
                    { className: "clear-button", title: "Clear All", html: (e) => `<div class="${e.className}" title="${e.title}">&#10799;</div>` },
                    e
                );
            t.on("initialize", () => {
                var e = j(i.html(i));
                        ...
                        a = (e, t) => {
                            ...
                            void 0 !== t &&
                                (((e, t) => {
                                    ...
                                    ? ((s = t), null == (n = (i = e).parentNode) || n.insertBefore(s, i.nextSibling))
                                    : ((e, t) => {
                                          var i;
            ...
            e.hook("instead", "onKeyDown", (i) => {
                ...
                (e.ignoreHover = !0),
                    ...
                    r &&
                        ...
                        (n = (o = r.querySelectorAll("[data-selectable]"))[Math.min(o.length - 1, s)]) &&
                        e.setActiveOption(n);
            });
        }),
                ...
                i.hook("after", "setupTemplates", () => {
                    ...
                    i.settings.render.item = (t, n) => {
                        ...
                        return (
                            ...
                            se(r, "click", (e) => {
                                i.isLocked ||
                                    (ie(e, !0), i.isLocked || (i.shouldDelete([o], e) && (i.removeItem(o), i.refreshOptions(!1), i.inputState())));
                            }),
                            o
                        );
                    };
        ...
        de.define("virtual_scroll", function () {
            ...
            if (
                (e.settings.shouldLoadMore ||
                    (e.settings.shouldLoadMore = () => {
                        if (n.clientHeight / (n.scrollHeight - n.scrollTop) > 0.9) return !0;
                        if (e.activeOption) {
                            var t = e.selectable();
            ...
            (e.setNextUrl = (e, t) => {
                ...
                e.hook("after", "refreshOptions", () => {
                    ...
                    var i;
                    c(t)
                        ? (i = e.render("loading_more", { query: t })) && (i.setAttribute("data-selectable", ""), (o = i))
                        : t in r && !n.querySelector(".no-results") && (i = e.render("no_more_results", { query: t })),
