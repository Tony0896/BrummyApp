                    ...
                    (o.prototype = {
                        ...
                        mix: function (t, e) {
                            var n = this,
                                ...
                                s = 1 - l;
                            return this.rgb(l * n.red() + s * i.red(), l * n.green() + s * i.green(), l * n.blue() + s * i.blue()).alpha(
                                n.alpha() * a + i.alpha() * (1 - a)
                            );
                        },
                        toJSON: function () {
                            return this.rgb();
            ...
            4: [
                function (t, e, n) {
                    ...
                    function h(t) {
                        ...
                        (n = s < 0.5 ? s * (1 + l) : s + l - s * l), (e = 2 * s - n), (a = [0, 0, 0]);
                        for (var u = 0; u < 3; u++)
                            (i = r + (1 / 3) * -(u - 1)),
                                i < 0 && i++,
                                i > 1 && i--,
                    ...
                    function f(t) {
                        ...
                        return 0 === o
                            ? [0, 0, 0]
                            : ((o *= 2), (a *= o <= 1 ? o : 2 - o), (n = (o + a) / 2), (e = (2 * a) / (o + a)), [i, 100 * e, 100 * n]);
                    }
                    function p(t) {
                        return o(h(t));
                    }
                    ...
                    function L(t) {
                        ...
                        return (
                            ...
                            (e = e > 0.0031308 ? 1.055 * Math.pow(e, 1 / 2.4) - 0.055 : (e *= 12.92)),
                    ...
                    function z(t) {
                        ...
                        return (
                            o <= 8
                                ? ((n = (100 * o) / 903.3), (a = 7.787 * (n / 100) + 16 / 116))
                            ...
                            (i = i / 108.883 <= 0.008859 ? (i = (108.883 * (a - l / 200 - 16 / 116)) / 7.787) : 108.883 * Math.pow(a - l / 200, 3)),
                            [e, n, i]
                        );
                    }
                    function B(t) {
                            ...
                            (t.controllers.bar = t.DatasetController.extend({
                                ...
                                updateElement: function (t, n, i) {
                                    ...
                                    (t._xScale = a.getScaleForId(r.xAxisID)),
                                        (t._yScale = a.getScaleForId(r.yAxisID)),
                                        ...
                                        (t._model = {
                                            ...
                                            backgroundColor: s.backgroundColor
                                                ? s.backgroundColor
                                                : e.getValueAtIndexOrDefault(l.backgroundColor, n, u.backgroundColor),
                                    ...
                                    for (e = 0; e < l; ++e)
                                        (n = a.getDatasetMeta(e)),
                                            n.bar &&
                                                ...
                                                (r === !1 ||
                                                    (r === !0 && s.indexOf(n.stack) === -1) ||
                                                    (void 0 === r && (void 0 === n.stack || s.indexOf(n.stack) === -1))) &&
                                                s.push(n.stack);
                                    return s.length;
                                },
                                ...
                                getRuler: function () {
                                    var t = this,
                                        ...
                                        u = s * i.barPercentage;
                                    return (
                                        (u = Math.min(e.getValueOrDefault(i.barThickness, u), e.getValueOrDefault(i.maxBarThickness, 1 / 0))),
                                        {
                                            stackCount: a,
                                            tickSize: r,
                                            categorySize: l,
                                        ...
                                        for (n = 0; n < t; ++n)
                                            (i = u.getDatasetMeta(n)),
                                                i.bar &&
                                                    ...
                                                    ((a = Number(h[n].data[e])), ((f < 0 && a < 0) || (f >= 0 && a > 0)) && (m += a));
                                    return (
                                ...
                                setHoverStyle: function (t) {
                                    ...
                                    (o.backgroundColor = a.hoverBackgroundColor
                                        ...
                                        : e.getValueAtIndexOrDefault(n.hoverBackgroundColor, i, e.getHoverColor(o.backgroundColor))),
                                        (o.borderColor = a.hoverBorderColor
                                            ? a.hoverBorderColor
                                            : e.getValueAtIndexOrDefault(n.hoverBorderColor, i, e.getHoverColor(o.borderColor))),
                                        (o.borderWidth = a.hoverBorderWidth
                                            ? a.hoverBorderWidth
                                            : e.getValueAtIndexOrDefault(n.hoverBorderWidth, i, o.borderWidth));
                                },
                                removeHoverStyle: function (t) {
                                    ...
                                    (o.backgroundColor = a.backgroundColor
                                        ? a.backgroundColor
                                        : e.getValueAtIndexOrDefault(n.backgroundColor, i, r.backgroundColor)),
                                        (o.borderColor = a.borderColor ? a.borderColor : e.getValueAtIndexOrDefault(n.borderColor, i, r.borderColor)),
                                        (o.borderWidth = a.borderWidth ? a.borderWidth : e.getValueAtIndexOrDefault(n.borderWidth, i, r.borderWidth));
                                },
                            })),
                            ...
                            (t.controllers.bubble = t.DatasetController.extend({
                                    ...
                                    e.extend(n, {
                                        ...
                                        _model: {
                                            x: a
                                                ...
                                                : l.getPixelForValue("object" == typeof c ? c : NaN, i, f, o.chart.isCombo),
                                ...
                                setHoverStyle: function (n) {
                                    ...
                                    l.radius = r.hoverRadius
                                        ? r.hoverRadius
                                        : e.getValueAtIndexOrDefault(a.hoverRadius, o, i.chart.options.elements.point.hoverRadius) +
                                ...
                                t.DatasetController.extend({
                                    ...
                                    update: function (t) {
                                        ...
                                        if (f < 2 * Math.PI) {
                                            ...
                                            var p = g + f,
                                                ...
                                                C = { width: 0.5 * (S.x - M.x), height: 0.5 * (S.y - M.y) };
                                            (u = Math.min(l / C.width, s / C.height)), (d = { x: (S.x + M.x) * -0.5, y: (S.y + M.y) * -0.5 });
                                        }
                                    ...
                                    updateElement: function (t, n, i) {
                                        var a = this,
                                            ...
                                            g =
                                                i && s.animateRotate
                                                    ...
                                                    : t.hidden
                                                    ? 0
                                                    : a.calculateCircumference(f.data[n]) * (l.circumference / (2 * Math.PI)),
                                        ...
                                        this.removeHoverStyle(t),
                                            (i && s.animateRotate) ||
                                                (0 === n ? (b.startAngle = l.rotation) : (b.startAngle = a.getMeta().data[n - 1]._model.endAngle),
                                    ...
                                    getMaxBorderWidth: function (t) {
                                        for (var e, n, i = 0, a = this.index, o = t.length, r = 0; r < o; r++)
                                            (e = t[r]._model ? t[r]._model.borderWidth : 0),
                                                (n = t[r]._chart ? t[r]._chart.config.data.datasets[a].hoverBorderWidth : 0),
                                                (i = e > i ? e : i),
                                                (i = n > i ? n : i);
                                        return i;
                                    },
                            ...
                            (t.controllers.line = t.DatasetController.extend({
                                        ...
                                        g &&
                                            ...
                                            (s._model = {
                                                ...
                                                cubicInterpolationMode: o.cubicInterpolationMode
                                                    ...
                                                    : n.getValueOrDefault(f.cubicInterpolationMode, c.cubicInterpolationMode),
                                            }),
                                            s.pivot()),
                                            i = 0,
                                            a = u.length;
                                ...
                                getPointBackgroundColor: function (t, e) {
                                    ...
                                    return (
                                        o.backgroundColor
                                            ...
                                            ? (i = n.getValueAtIndexOrDefault(a.pointBackgroundColor, e, i))
                                ...
                                getPointBorderColor: function (t, e) {
                                    ...
                                    return (
                                        o.borderColor
                                            ? (i = o.borderColor)
                                            : a.pointBorderColor
                                            ? (i = n.getValueAtIndexOrDefault(a.pointBorderColor, e, i))
                                    ...
                                    return (
                                        isNaN(o.borderWidth)
                                            ? isNaN(a.pointBorderWidth)
                                                ...
                                                : (i = n.getValueAtIndexOrDefault(a.pointBorderWidth, e, i))
                                            : (i = o.borderWidth),
                                        i
                                    );
                                },
                                    ...
                                    if (u.options.stacked) {
                                        for (i = 0; i < n; i++)
                                            if (
                                                ...
                                                "line" === o.type && o.yAxisID === u.id && l.isDatasetVisible(i))
                                            ) {
                                ...
                                updateBezierControlPoints: function () {
                                    ...
                                    if (l.chart.options.elements.line.capBezierPoints)
                                        for (e = 0, i = d.length; e < i; ++e)
                                            (o = d[e]._model),
                                                (o.controlPointPreviousX = t(o.controlPointPreviousX, u.left, u.right)),
                                                (o.controlPointPreviousY = t(o.controlPointPreviousY, u.top, u.bottom)),
                                                (o.controlPointNextX = t(o.controlPointNextX, u.left, u.right)),
                                                (o.controlPointNextY = t(o.controlPointNextY, u.top, u.bottom));
                                },
                                draw: function () {
                                    var n = this,
                                        i = n.chart,
                                ...
                                setHoverStyle: function (t) {
                                    ...
                                    (o.radius =
                                        a.hoverRadius ||
                                        n.getValueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.elements.point.hoverRadius)),
                                        (o.backgroundColor =
                                            a.hoverBackgroundColor ||
                                            n.getValueAtIndexOrDefault(e.pointHoverBackgroundColor, i, n.getHoverColor(o.backgroundColor))),
                                        (o.borderColor =
                                            a.hoverBorderColor ||
                                            n.getValueAtIndexOrDefault(e.pointHoverBorderColor, i, n.getHoverColor(o.borderColor))),
                                        (o.borderWidth = a.hoverBorderWidth || n.getValueAtIndexOrDefault(e.pointHoverBorderWidth, i, o.borderWidth));
                                },
                                removeHoverStyle: function (t) {
                                    var e = this,
                                    ...
                                    void 0 !== i.radius && void 0 === i.pointRadius && (i.pointRadius = i.radius),
                                        (r.radius = o.radius || n.getValueAtIndexOrDefault(i.pointRadius, a, e.chart.options.elements.point.radius)),
                                        (r.backgroundColor = e.getPointBackgroundColor(t, a)),
                                        (r.borderColor = e.getPointBorderColor(t, a)),
                                        (r.borderWidth = e.getPointBorderWidth(t, a));
                                },
                            }));
                    };
                },
                                ...
                                updateElement: function (t, n, i) {
                                    for (
                                        var a = this,
                                            ...
                                            c = o.data.labels,
                                            h = a.calculateCircumference(r.data[n]),
                                            f = u.xCenter,
                                            g = u.yCenter,
                                            p = 0,
                                            m = a.getMeta(),
                            ...
                            (t.controllers.radar = t.DatasetController.extend({
                                    ...
                                    void 0 !== r.radius && void 0 === r.pointRadius && (r.pointRadius = r.radius),
                                        ...
                                        e.extend(t, {
                                            ...
                                            _model: {
                                                ...
                                                tension: o.tension
                                                    ? o.tension
                                                    : e.getValueOrDefault(r.lineTension, a.chart.options.elements.line.tension),
                                                radius: o.radius ? o.radius : e.getValueAtIndexOrDefault(r.pointRadius, n, s.radius),
                                                backgroundColor: o.backgroundColor
                                                    ? o.backgroundColor
                                                    : e.getValueAtIndexOrDefault(r.pointBackgroundColor, n, s.backgroundColor),
                                                borderColor: o.borderColor
                                                    ? o.borderColor
                                                    : e.getValueAtIndexOrDefault(r.pointBorderColor, n, s.borderColor),
                                                borderWidth: o.borderWidth
                                                    ? o.borderWidth
                                                    : e.getValueAtIndexOrDefault(r.pointBorderWidth, n, s.borderWidth),
                                ...
                                setHoverStyle: function (t) {
                                    ...
                                    (o.radius = i.hoverRadius
                                        ? i.hoverRadius
                                        : e.getValueAtIndexOrDefault(n.pointHoverRadius, a, this.chart.options.elements.point.hoverRadius)),
                                        (o.backgroundColor = i.hoverBackgroundColor
                                            ? i.hoverBackgroundColor
                                            : e.getValueAtIndexOrDefault(n.pointHoverBackgroundColor, a, e.getHoverColor(o.backgroundColor))),
                                        (o.borderColor = i.hoverBorderColor
                                            ? i.hoverBorderColor
                                            : e.getValueAtIndexOrDefault(n.pointHoverBorderColor, a, e.getHoverColor(o.borderColor))),
                                        (o.borderWidth = i.hoverBorderWidth
                                            ? i.hoverBorderWidth
                                            : e.getValueAtIndexOrDefault(n.pointHoverBorderWidth, a, o.borderWidth));
                                },
                                removeHoverStyle: function (t) {
                                    var n = this.chart.data.datasets[t._datasetIndex],
                                        i = t.custom || {},
                                    ...
                                    (o.radius = i.radius ? i.radius : e.getValueAtIndexOrDefault(n.pointRadius, a, r.radius)),
                                        (o.backgroundColor = i.backgroundColor
                                            ? i.backgroundColor
                                            : e.getValueAtIndexOrDefault(n.pointBackgroundColor, a, r.backgroundColor)),
                                        (o.borderColor = i.borderColor
                                            ? i.borderColor
                                            : e.getValueAtIndexOrDefault(n.pointBorderColor, a, r.borderColor)),
                                        (o.borderWidth = i.borderWidth
                                            ? i.borderWidth
                                            : e.getValueAtIndexOrDefault(n.pointBorderWidth, a, r.borderWidth));
                                },
                            }));
                    };
                },
                                    ...
                                    for (var n, i, a = this.animations, o = 0; o < a.length; )
                                        (n = a[o]),
                                            ...
                                            n.currentStep >= n.numSteps
                                                ? (e.callback(n.onAnimationComplete, [n], i), (i.animating = !1), a.splice(o, 1))
                                                : ++o;
                                },
                            }),
                        ...
                        (e.drawPoint = function (e, n, i, a, o) {
                            ...
                            (e.lineTo = function (t, e, n, i) {
                                return n.steppedLine
                                    ? ("after" === n.steppedLine ? t.lineTo(e.x, n.y) : t.lineTo(n.x, e.y), void t.lineTo(n.x, n.y))
                                    : n.tension
                            ...
                            a.extend(t.prototype, {
                                construct: function (n, i) {
                                    ...
                                    return (
                                        ...
                                        l && s
                                            ...
                                            : void console.error("Failed to create chart: can't acquire context from the given item")
                                    );
                                },
                                initialize: function () {
                                    var t = this;
                                ...
                                buildScales: function () {
                                    ...
                                    n.scales &&
                                        ...
                                        n.scale && r.push({ options: n.scale, dtype: "radialLinear", isDefault: !0, dposition: "chartArea" }),
                                        a.each(r, function (n) {
                                            var r = n.options,
                                ...
                                update: function (t, e) {
                                    ...
                                    if ((n(i), o.notify(i, "beforeUpdate") !== !1)) {
                                        ...
                                        a.each(
                                            ...
                                            i._bufferedRender ? (i._bufferedRequest = { lazy: e, duration: t }) : i.render(t, e);
                                    }
                                },
                                ...
                                destroy: function () {
                                    ...
                                    s && (l.unbindEvents(), a.clear(l), r.releaseContext(l.ctx), (l.canvas = null), (l.ctx = null)),
                                        o.notify(l, "destroy"),
                            ...
                            n.extend(t.Element.prototype, {
                                ...
                                transition: function (t) {
                                    var n = this,
                                        ...
                                        o = n._view;
                                    return i && 1 !== t
                                        ? (o || (o = n._view = {}), a || (a = n._start = {}), e(a, o, i, t), n)
                ...
                function (t, e, n) {
                    ...
                    e.exports = function (t) {
                        function e(t, e, n) {
                            var i;
                            return (
                                "string" == typeof t ? ((i = parseInt(t, 10)), t.indexOf("%") !== -1 && (i = (i / 100) * e.parentNode[n])) : (i = t),
                                i
                            );
                        }
                        function n(t) {
                        ...
                        (o.each = function (t, e, n, i) {
                                    ...
                                    o.each(Array.prototype.slice.call(arguments, 1), function (e) {
                                        o.each(e, function (e, i) {
                                            var a = n.hasOwnProperty(i),
                                                r = a ? n[i] : {};
                                            "scales" === i
                                                ? (n[i] = o.scaleMerge(r, e))
                                                : "scale" === i
                                                ? (n[i] = o.configMerge(r, t.scaleService.getScaleDefaults(e.type), e))
                                                : !a || "object" != typeof r || o.isArray(r) || null === r || "object" != typeof e || o.isArray(e)
                                                ? (n[i] = e)
                                                : (n[i] = o.configMerge(r, e));
                                        });
                                    }),
                                    n
                                );
                                ...
                                return (
                                    o.each(n, function (e, n) {
                                        "xAxes" === n || "yAxes" === n
                                            ? i.hasOwnProperty(n)
                                                ? o.each(e, function (e, a) {
                                                      ...
                                                      a >= i[n].length || !i[n][a].type
                                                          ? i[n].push(o.configMerge(l, e))
                                                          : e.type && e.type !== i[n][a].type
                                                          ? (i[n][a] = o.configMerge(i[n][a], l, e))
                                                          : (i[n][a] = o.configMerge(i[n][a], e));
                                                  })
                                                : ((i[n] = []),
                                                  o.each(e, function (e) {
                                            ...
                                            : i.hasOwnProperty(n) && "object" == typeof i[n] && null !== i[n] && "object" == typeof e
                                        ...
                                        i.model.skip ||
                                            ...
                                            (o.almostEquals(i.deltaK, 0, this.EPSILON)
                                                ...
                                                : ((u = i.mK / i.deltaK),
                                                  ...
                                                  h <= 9 || ((c = 3 / Math.sqrt(h)), (i.mK = u * c * i.deltaK), (a.mK = d * c * i.deltaK))));
                                var f;
                                for (e = 0; e < l; ++e)
                                    (i = r[e]),
                                        i.model.skip ||
                            ...
                            (o.niceNum = function (t, e) {
                                var n,
                                    ...
                                    a = t / Math.pow(10, i);
                                return (
                                    (n = e ? (a < 1.5 ? 1 : a < 3 ? 2 : a < 7 ? 5 : 10) : a <= 1 ? 1 : a <= 2 ? 2 : a <= 5 ? 5 : 10),
                                    n * Math.pow(10, i)
                                );
                            });
                        var r = (o.easingEffects = {
                            ...
                            easeInElastic: function (t) {
                                ...
                                return 0 === t
                                    ...
                                    ? 1
                                    : (n || (n = 0.3),
                                      i < Math.abs(1) ? ((i = 1), (e = n / 4)) : (e = (n / (2 * Math.PI)) * Math.asin(1 / i)),
                            ...
                            easeInOutElastic: function (t) {
                                ...
                                return 0 === t
                                    ...
                                    : (n || (n = 1 * (0.3 * 1.5)),
                                      i < Math.abs(1) ? ((i = 1), (e = n / 4)) : (e = (n / (2 * Math.PI)) * Math.asin(1 / i)),
                                      t < 1
                                          ? -0.5 * (i * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / n))
                                          : i * Math.pow(2, -10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / n) * 0.5 + 1);
                            },
                        ...
                        (o.requestAnimFrame = (function () {
                            ...
                            (o.getRelativePosition = function (t, e) {
                                ...
                                return (
                                    (n = Math.round((((n - l.left - u) / f) * r.width) / e.currentDevicePixelRatio)),
                        ...
                        t.layoutService = {
                            ...
                            update: function (t, a, o) {
                                function r(t) {
                                    var e,
                                        n = t.isHorizontal();
                                    n ? ((e = t.update(t.fullWidth ? k : I, D)), (A -= e.height)) : ((e = t.update(C, S)), (I -= e.width)),
                                ...
                                function u(t) {
                                    t.isHorizontal()
                                        ? ((t.left = t.fullWidth ? h : L),
                                          ...
                                          (t.bottom = q + t.height),
                                          (q = t.bottom))
                                        : ((t.left = H), (t.right = H + t.width), (t.top = O), (t.bottom = O + A), (H = t.right));
                                }
                                if (t) {
                                    var d = t.options.layout,
                                        ...
                                        p = 0;
                                    isNaN(c)
                                        ? ((h = c.left || 0), (f = c.right || 0), (g = c.top || 0), (p = c.bottom || 0))
                                        : ((h = c), (f = c), (g = c), (p = c));
                                    ...
                                    i.each(m.concat(b), u),
                                        ...
                                        i.each(v, u),
                                        i.each(x, u),
                                        (t.chartArea = { left: L, top: O, right: L + I, bottom: O + A }),
                                        i.each(y, function (e) {
                                ...
                                notify: function (t, e, n) {
                                    ...
                                    for (i = 0; i < u; ++i)
                                        if (
                                            ...
                                            (o = a.plugin),
                                            (l = o[e]),
                                            "function" == typeof l && ((r = [t].concat(n || [])), r.push(a.options), l.apply(o, r) === !1))
                                        )
                                            return !1;
                                    return !0;
                                },
                                    ...
                                    return (
                                        this._plugins.concat(r.plugins || []).forEach(function (t) {
                                            ...
                                            if (n === -1) {
                                                var i = t.id,
                                                    r = s[i];
                                                r !== !1 && (r === !0 && (r = e.clone(l[i])), a.push(t), o.push({ plugin: t, options: r || {} }));
                                            }
                                        }),
                                        (i.descriptors = o),
                                        (i.id = this._cacheId),
                            ...
                            (t.Scale = t.Element.extend({
                                ...
                                update: function (t, e, n) {
                                    ...
                                    return (
                                        ...
                                        (a.maxWidth = t),
                                        (a.maxHeight = e),
                                        (a.margins = i.extend({ left: 0, right: 0, top: 0, bottom: 0 }, n)),
                                ...
                                calculateTickRotation: function () {
                                    ...
                                    if (t.options.display && t.isHorizontal())
                                        for (
                                            var l,
                                                s,
                                                u = i.longestText(e, o.font, t.ticks, t.longestTextCache),
                                                d = u,
                                ...
                                fit: function () {
                                    ...
                                    if (
                                        (d
                                            ? (a.width = t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth)
                                        ...
                                        if (d) {
                                            ...
                                            var k = t.ticks[0],
                                                ...
                                                S = e(t.ctx, M, c.font);
                                            0 !== t.labelRotation
                                                ? ((t.paddingLeft = "bottom" === o.position ? b * w + 3 : b * m + 3),
                                                  (t.paddingRight = "bottom" === o.position ? b * m + 3 : b * S + 3))
                                ...
                                draw: function (e) {
                                    ...
                                    if (o.display) {
                                        ...
                                        if (p) {
                                            if (
                                                ((r = !1),
                                                (M + d.autoSkipPadding) * a.ticks.length > a.width - (a.paddingLeft + a.paddingRight) &&
                                                    (r =
                                                        1 +
                                                        Math.floor(
                                                            ((M + d.autoSkipPadding) * a.ticks.length) / (a.width - (a.paddingLeft + a.paddingRight))
                                        ...
                                        if (
                                            (i.each(a.ticks, function (t, n) {
                                                if (void 0 !== t && null !== t) {
                                                    ...
                                                    if ((!s || l) && void 0 !== t && null !== t) {
                                                        var h, g, m, v;
                                                        n === ("undefined" != typeof a.zeroLineIndex ? a.zeroLineIndex : 0)
                                                            ? ((h = c.zeroLineWidth),
                                                              (g = c.zeroLineColor),
                                                              (m = c.zeroLineBorderDash),
                                                              (v = c.zeroLineBorderDashOffset))
                                                            : ((h = i.getValueAtIndexOrDefault(c.lineWidth, n)),
                                                        ...
                                                        if (p) {
                                                            "bottom" === o.position
                                                                ? ((O = f ? "middle" : "top"), (V = f ? "right" : "center"), (L = a.top + b))
                                                                : ((O = f ? "middle" : "bottom"), (V = f ? "left" : "center"), (L = a.bottom - b));
                                            ...
                                            if (p)
                                                (P = a.left + (a.right - a.left) / 2),
                                                    (_ = "bottom" === o.position ? a.bottom - y.size / 2 : a.top + y.size / 2);
                                            else {
                                        ...
                                        if (c.drawBorder) {
                                            ...
                                            p
                                                ? ((V = O = "top" === o.position ? a.bottom : a.top), (V += z), (O += z))
                                                : ((R = L = "left" === o.position ? a.right : a.left), (R += z), (L += z)),
                                                s.beginPath(),
                                                s.moveTo(R, V),
                                                s.lineTo(L, O),
                                                s.stroke();
                                ...
                                logarithmic: function (t, n) {
                                    ...
                                    0 === l
                                        ? ((i = Math.floor(e.log10(n.minNotZero))),
                                          ...
                                          o.push(l),
                                          (l = a * Math.pow(10, i)))
                                        : ((i = Math.floor(e.log10(l))), (a = Math.floor(l / Math.pow(10, i))));
                ...
                function (t, e, n) {
                    ...
                    e.exports = function (t) {
                        ...
                        function o(t, e) {
                            ...
                            return (
                                (n.font = s.fontString(d, e._titleFontStyle, e._titleFontFamily)),
                                s.each(e.title, g),
                        ...
                        function l(t, e, n) {
                            var i = t.x,
                                ...
                                c = l + r;
                            return (
                                "right" === s ? (i -= e.width) : "center" === s && (i -= e.width / 2),
                            ...
                            (t.Tooltip = t.Element.extend({
                                ...
                                getCaretPosition: function (t, e, n) {
                                    ...
                                    if ("center" === h)
                                        (l = g + m / 2),
                                            "left" === c
                                                ? ((i = f), (a = i - u), (o = i), (r = l + u), (s = l - u))
                                                : ((i = f + p), (a = i + u), (o = i), (r = l - u), (s = l + u));
                                    else if (
                                        ("left" === c
                                            ? ((a = f + d + u), (i = a - u), (o = a + u))
                                            : "right" === c
                                            ? ((a = f + p - d - u), (i = a - u), (o = a + u))
                                            : ((a = f + p / 2), (i = a - u), (o = a + u)),
                                        "top" === h)
                                    )
                                        (r = g), (l = r - u), (s = r);
            ...
            35: [
                function (t, e, n) {
                    ...
                    e.exports = function (t) {
                        var e = t.helpers,
                            n = t.defaults.global;
                        (n.elements.arc = { backgroundColor: n.defaultColor, borderColor: "#fff", borderWidth: 2 }),
                                ...
                                draw: function () {
                                    ...
                                    for (
                                        ...
                                        (i = d[t]),
                                            ...
                                            (o = i._view),
                                            0 === t
                                                ? o.skip || (s.moveTo(o.x, o.y), (h = t))
                                                : ((a = h === -1 ? a : d[h]),
                                                  o.skip ||
                                                      ((h !== t - 1 && !u) || h === -1 ? s.moveTo(o.x, o.y) : e.canvas.lineTo(s, a._view, i._view),
                                                      (h = t)));
                                    s.stroke(), s.restore();
                                },
                            }));
                            ...
                            (t.elements.Point = t.Element.extend({
                                ...
                                draw: function (e) {
                                    ...
                                    n.skip ||
                                        ...
                                        void 0 !== e &&
                                            (r.x < e.left || e.right * f < r.x || r.y < e.top || e.bottom * f < r.y) &&
                                            (r.x < e.left
                                                ? (g = (d - r.x) / (e.left - r.x))
                                                : e.right * f < r.x
                                                ? (g = (r.x - d) / (r.x - e.right))
                                                : r.y < e.top
                                                ? (g = (c - r.y) / (e.top - r.y))
                                                : e.bottom * f < r.y && (g = (r.y - c) / (r.y - e.bottom)),
                ...
                function (t, e, n) {
                    ...
                    e.exports = function (t) {
                        ...
                        function n(t, n) {
                            ...
                            if (
                                ((t._chartjs = { initial: { height: a, width: o, style: { display: i.display, height: i.height, width: i.width } } }),
                    ...
                    e.exports = function (t) {
                        ...
                        function n(t) {
                            ...
                            if (
                                ...
                                if ("number" == typeof o && isFinite(o)) return (e = i.isHorizontal()), { x: e ? o : null, y: e ? null : o };
                            }
                            return null;
                        }
                        function i(t, e, n) {
                            ...
                            for (t.beginPath(), s = 0, u = p + !!l; s < u; ++s)
                                (d = s % p),
                                    ...
                                    f && g
                                        ...
                                        : x && y && (m ? (f && v.push(c), g && b.push(h)) : (r(t, v, b, x, y), (x = y = 0), (v = []), (b = [])));
                                ...
                                for (s = 0; s < c; ++s)
                                    (l = o.getDatasetMeta(s)),
                                        ...
                                        u &&
                                            ...
                                            (d = { visible: o.isDatasetVisible(s), fill: e(u, s, c), chart: o, el: u }),
                                        (l.$filler = d),
                                        f.push(d);
                            ...
                            (t.Legend = t.Element.extend({
                                ...
                                fit: function () {
                                    var n = this,
                                        ...
                                        m = n.isHorizontal();
                                    if (
                                        (m ? ((p.width = n.maxWidth), (p.height = r ? 10 : 0)) : ((p.width = r ? 10 : 0), (p.height = n.maxHeight)),
                                        r)
                                    )
                                        if (((l.font = f), m)) {
                                            ...
                                            (l.textAlign = "left"),
                                                ...
                                                i.each(n.legendItems, function (t, i) {
                                                    ...
                                                    v[v.length - 1] + r + o.padding >= n.width && ((b += d + o.padding), (v[v.length] = n.left)),
                                            ...
                                            i.each(n.legendItems, function (t, n) {
                                                ...
                                                M + S > p.height && ((k += w + o.padding), y.push(w), (w = 0), (M = 0)),
                                                    (w = Math.max(w, a)),
                                                    (M += S),
                                ...
                                draw: function () {
                                    ...
                                    if (a.display) {
                                        ...
                                        var b = e(o, g),
                                            ...
                                            w = n.isHorizontal();
                                        d = w
                                            ? { x: n.left + (s - u[0]) / 2, y: n.top + o.padding, line: 0 }
                                        ...
                                        i.each(n.legendItems, function (t, e) {
                                            var i = c.measureText(t.text).width,
                                                ...
                                                l = d.y;
                                            w
                                                ? r + a >= s && ((l = d.y += M), d.line++, (r = d.x = n.left + (s - u[d.line]) / 2))
                                                : l + M > n.bottom &&
                                                  ((r = d.x = r + n.columnWidths[d.line] + o.padding), (l = d.y = n.top + o.padding), d.line++),
                                                y(r, l, t),
                                                (x[e].left = r),
                                                (x[e].top = l),
                                                k(r, l, t, i),
                                                w ? (d.x += a + o.padding) : (d.y += M);
                                        });
                                    }
                                },
                                handleEvent: function (t) {
                            ...
                            })),
                            {
                                ...
                                beforeUpdate: function (e) {
                                    var o = e.options.legend,
                                        r = e.legend;
                                    o
                                        ? ((o = i.configMerge(t.defaults.global.legend, o)), r ? (a.configure(e, r, o), (r.options = o)) : n(e, o))
                                        : r && (a.removeBox(e, r), delete e.legend);
                                },
                            ...
                            (t.Title = t.Element.extend({
                                ...
                                fit: function () {
                                    var e = this,
                                        ...
                                        s = e.minSize;
                                    e.isHorizontal()
                                        ? ((s.width = e.maxWidth), (s.height = r ? l + 2 * a.padding : 0))
                                        : ((s.width = r ? l + 2 * a.padding : 0), (s.height = e.maxHeight)),
                                        (e.width = s.width),
                                        (e.height = s.height);
                                },
                                afterFit: a,
                                ...
                                draw: function () {
                                    ...
                                    if (o.display) {
                                        var l,
                                            ...
                                            v = e.bottom,
                                            b = e.right;
                                        (i.fillStyle = a(o.fontColor, r.defaultFontColor)),
                                            (i.font = f),
                                            e.isHorizontal()
                                                ? ((l = m + (b - m) / 2), (s = p + (v - p) / 2), (u = b - m))
                                                : ((l = "left" === o.position ? m + d / 2 : b - d / 2),
                                                  (s = p + (v - p) / 2),
                                                  (u = v - p),
                            ...
                            })),
                            {
                                ...
                                beforeUpdate: function (a) {
                                    var o = a.options.title,
                                        r = a.titleBlock;
                                    o
                                        ? ((o = n.configMerge(t.defaults.global.title, o)), r ? (i.configure(a, r, o), (r.options = o)) : e(a, o))
                                        : r && (t.layoutService.removeBox(a, r), delete a.titleBlock);
                                },
                            }
                        );
                    };
                            ...
                            i = t.Scale.extend({
                                ...
                                determineDataLimits: function () {
                                    ...
                                    void 0 !== t.options.ticks.min &&
                                        ((i = e.indexOf(n, t.options.ticks.min)), (t.minIndex = i !== -1 ? i : t.minIndex)),
                                        void 0 !== t.options.ticks.max &&
                                            ((i = e.indexOf(n, t.options.ticks.max)), (t.maxIndex = i !== -1 ? i : t.maxIndex)),
                                        (t.min = n[t.minIndex]),
                                        (t.max = n[t.maxIndex]);
                                },
                                buildTicks: function () {
                                ...
                                getPixelForValue: function (t, e, n, i) {
                                    ...
                                    if (
                                        (void 0 !== t && null !== t && (a = o.isHorizontal() ? t.x : t.y), void 0 !== a || (void 0 !== t && isNaN(e)))
                                    ) {
                                        var l = o.getLabels();
                                        t = a || t;
                                        var s = l.indexOf(t);
                                    ...
                                    if (o.isHorizontal()) {
                                        var u = o.width / r,
                                            d = u * (e - o.minIndex);
                                        return (
                                            ((o.options.gridLines.offsetGridLines && i) || (o.maxIndex === o.minIndex && i)) && (d += u / 2),
                                            o.left + Math.round(d)
                                        );
                                    }
                                    var c = o.height / r,
                                            ...
                                            a.isDatasetVisible(r) &&
                                                ...
                                                e.each(o.data, function (t, e) {
                                                    ...
                                                    isNaN(a) ||
                                                        ...
                                                        ((u[e] = u[e] || 0),
                                                        (d[e] = d[e] || 0),
                                                        i.relativePoints ? (u[e] = 100) : a < 0 ? (d[e] += a) : (u[e] += a));
                                                });
                                        }),
                                            e.each(c, function (t) {
                                        ...
                                        e.each(r, function (i, o) {
                                            ...
                                            a.isDatasetVisible(o) &&
                                                ...
                                                e.each(i.data, function (t, e) {
                                                    ...
                                                    isNaN(i) ||
                                                        r.data[e].hidden ||
                                                        (null === n.min ? (n.min = i) : i < n.min && (n.min = i),
                        ...
                        t.LinearScaleBase = t.Scale.extend({
                            handleTickRangeOptions: function () {
                                ...
                                void 0 !== i.min
                                    ...
                                    : void 0 !== i.suggestedMin &&
                                      (null === t.min ? (t.min = i.suggestedMin) : (t.min = Math.min(t.min, i.suggestedMin))),
                                    void 0 !== i.max
                                        ? (t.max = i.max)
                                        : void 0 !== i.suggestedMax &&
                                          (null === t.max ? (t.max = i.suggestedMax) : (t.max = Math.max(t.max, i.suggestedMax))),
                            ...
                            buildTicks: function () {
                                var n = this,
                                    ...
                                    o = n.getTickLimit();
                                o = Math.max(2, o);
                                var r = { maxTicks: o, min: a.min, max: a.max, stepSize: e.getValueOrDefault(a.fixedStepSize, a.stepSize) },
                                    l = (n.ticks = t.Ticks.generators.linear(r, n));
                                n.handleDirectionalChanges(),
                                    (n.max = e.max(l)),
                                    (n.min = e.min(l)),
                                    a.reverse ? (l.reverse(), (n.start = n.max), (n.end = n.min)) : ((n.start = n.min), (n.end = n.max));
                            },
                            convertTicksToLabels: function () {
                                var e = this;
                            ...
                            i = t.Scale.extend({
                                determineDataLimits: function () {
                                        ...
                                        e.each(l, function (a, r) {
                                            ...
                                            o.isDatasetVisible(r) &&
                                                ...
                                                e.each(a.data, function (t, e) {
                                                    ...
                                                    isNaN(o) ||
                                                        l.data[e].hidden ||
                                                        ((a[e] = a[e] || 0), i.relativePoints ? (a[e] = 100) : (a[e] += o));
                                                }));
                                        }),
                                            e.each(c, function (t) {
                                                var i = e.min(t),
                                    ...
                                    (n.min = s(a.min, n.min)),
                                        ...
                                        n.min === n.max &&
                                            (0 !== n.min && null !== n.min
                                                ? ((n.min = Math.pow(10, Math.floor(e.log10(n.min)) - 1)),
                                                  (n.max = Math.pow(10, Math.floor(e.log10(n.max)) + 1)))
                                                : ((n.min = 1), (n.max = 10)));
                                },
                                buildTicks: function () {
                                    var n = this,
                                    ...
                                    n.isHorizontal() || r.reverse(),
                                        (n.max = e.max(r)),
                                        (n.min = e.min(r)),
                                        a.reverse ? (r.reverse(), (n.start = n.max), (n.end = n.min)) : ((n.start = n.min), (n.end = n.max));
                                },
                                convertTicksToLabels: function () {
                                ...
                                getPixelForValue: function (t) {
                                    ...
                                    return (
                                        o.isHorizontal()
                                            ? ((a = e.log10(o.end) - e.log10(r)),
                                              0 === l ? (i = o.left) : ((n = o.width), (i = o.left + (n / a) * (e.log10(l) - e.log10(r)))))
                                            : ((n = o.height),
                                              0 !== r || u.reverse
                                                  ? 0 === o.end && u.reverse
                                                      ? ((a = e.log10(o.start) - e.log10(o.minNotZero)),
                                                        (i =
                                                            l === o.end
                                                                ? o.top
                                                                : l === o.minNotZero
                                                                ? o.top + 0.02 * n
                                                                : o.top + 0.02 * n + ((0.98 * n) / a) * (e.log10(l) - e.log10(o.minNotZero))))
                                                      : 0 === l
                                                      ? (i = u.reverse ? o.top : o.bottom)
                                                      : ((a = e.log10(o.end) - e.log10(r)),
                                                        (n = o.height),
                                                        (i = o.bottom - (n / a) * (e.log10(l) - e.log10(r))))
                                                  : ((a = e.log10(o.end) - e.log10(o.minNotZero)),
                                                    (i =
                                                        l === r
                                                            ? o.bottom
                                                            : l === o.minNotZero
                                                            ? o.bottom - 0.02 * n
                                                            : o.bottom - 0.02 * n - ((0.98 * n) / a) * (e.log10(l) - e.log10(o.minNotZero))))),
                                        i
                                    );
                                },
                                getValueForPixel: function (t) {
                                    ...
                                    return (
                                        a.isHorizontal()
                                            ? ((i = a.width), (n = a.start * Math.pow(10, ((t - a.left) * o) / i)))
                                            : ((i = a.height), (n = Math.pow(10, ((a.bottom - t) * o) / i) / a.start)),
                                        n
                                    );
                                },
                            });
            ...
            48: [
                function (t, e, n) {
                    ...
                    e.exports = function (t) {
                        ...
                        function i(t, e, n) {
                            return f.isArray(n)
                                ? { w: f.longestText(t, t.font, n), h: n.length * e + 1.5 * (n.length - 1) * e }
                        ...
                        function s(t, e, n, i) {
                            if (f.isArray(e)) for (var a = n.y, o = 1.5 * i, r = 0; r < e.length; ++r) t.fillText(e[r], n.x, a), (a += o);
                        ...
                        function c(t, n, i, a) {
                            var o = t.ctx;
                            if (
                                ((o.strokeStyle = f.getValueAtIndexOrDefault(n.color, a - 1)),
                                (o.lineWidth = f.getValueAtIndexOrDefault(n.lineWidth, a - 1)),
                        ...
                        (e.exports = function (t) {
                            function e(t, e) {
                                ...
                                return "string" != typeof a && a.call
                                    ? (console.warn("options.time.format is deprecated and replaced by options.time.parser."), a(e))
                                    : i(e, a);
                            }
                            function n(t, e, n, i) {
                            ...
                            function a(t, e, n, i) {
                                var a = l[n],
                                    ...
                                    s = 1,
                                    u = e - t;
                                if (a.steps) for (var d = a.steps.length, c = 0; c < d && r > i; c++) (s = a.steps[c]), (r = Math.ceil(u / (o * s)));
                                else for (; r > i && i > 0; ) ++s, (r = Math.ceil(u / (o * s)));
                                return s;
                            }
                            function o(t, e, n) {
                                var a = [];
                            ...
                            t.Ticks.generators.time = function (t, e) {
                                ...
                                return (
                                    "week" === t.unit && r !== !1
                                        ? ((n = i(e.min).startOf("isoWeek").isoWeekday(r).valueOf()),
                                          (a = i(e.max).startOf("isoWeek").isoWeekday(r)),
                            ...
                            var u = t.Scale.extend({
                                ...
                                determineDataLimits: function () {
                                    ...
                                    r.each(l.labels, function (r, l) {
                                        ...
                                        r.each(l.datasets, function (l, u) {
                                            var d = [];
                                            "object" == typeof l.data[0] && null !== l.data[0] && n.chart.isDatasetVisible(u)
                                                ? r.each(l.data, function (r, l) {
                                ...
                                buildTicks: function () {
                                    ...
                                    (l.ticks = t.Ticks.generators.time(
                                        { maxTicks: h, min: i, max: o, stepSize: g, unit: f, isoWeekday: s.isoWeekday },
                                        { min: u, max: d }
                                    )),
                                        (l.max = r.max(l.ticks)),
                                        (l.min = r.min(l.ticks));
                                ...
                                getLabelForIndex: function (t, n) {
                                    ...
                                    return (
                                        null !== o && "object" == typeof o && (a = i.getRightValue(o)),
                                ...
                                getPixelForValue: function (t, n, i) {
                                    var a = this,
                                        o = null;
                                    if (
                                        (void 0 !== n && void 0 !== i && (o = a._parsedData.datasets[i][n]),
                                        null === o &&
                                            ((t && t.isValid) || (t = e(a, a.getRightValue(t))), t && t.isValid && t.isValid() && (o = t.valueOf())),
                                        null !== o)
                                    )
