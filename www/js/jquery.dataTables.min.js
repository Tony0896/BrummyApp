...
(function (l) {
    ...
    function Kb(a) {
        ...
        var k = function (n) {
            ...
            (e.return && "Enter" !== n.key) ||
                p == e.sSearch ||
                (za(a, { sSearch: p, bRegex: e.bRegex, bSmart: e.bSmart, bCaseInsensitive: e.bCaseInsensitive, return: e.return }),
                (a._iDisplayStart = 0),
                ja(a));
        };
        ...
        for (c = a.aoData.length; h < c; h++) {
            ...
            if (!f._aFilterData) {
                ...
                for (d = b.length; e < d; e++) {
                    var k = b[e];
                    k.bSearchable
                        ? ((k = T(a, h, e, "filter")), null === k && (k = ""), "string" !== typeof k && k.toString && (k = k.toString()))
                        : (k = "");
        ...
        for (var d = 0, e = b.length; d < e; d++) {
            ...
            h.bSortable &&
                (0 < c.length && c[0].col == d
                    ? (k.setAttribute("aria-sort", "asc" == c[0].dir ? "ascending" : "descending"), (h = f[c[0].index + 1] || f[0]))
                    : (h = f[0]),
    ...
    function Da(a, b) {
        ...
        b <= c
            ...
            : (a >= b - 1 - d ? (a = ra(b - (c - 2), b)) : ((a = ra(a - d + 2, a + d - 1)), a.push("ellipsis"), a.push(b - 1)),
    ...
    l.extend(B.prototype, {
        ...
        iterator: function (a, b, c, d) {
            ...
            return e.length || d
                ? ((a = new B(g, a ? e.concat.apply([], e) : e)), (b = a.selector), (b.rows = m.rows), (b.cols = m.cols), (b.opts = m.opts), a)
                : this;
        },
        lastIndexOf:
            N.lastIndexOf ||
                ...
                h = function (f, g) {
                    if (Array.isArray(f) || f instanceof l) for (var k = 0, m = f.length; k < m; k++) h(f[k], g);
                        ...
                        f.nodeName && "tr" === f.nodeName.toLowerCase()
                            ? e.push(f)
                            : ((k = l("<tr><td></td></tr>").addClass(g)), (l("td", k).addClass(g).html(f)[0].colSpan = oa(a)), e.push(k[0]));
                };
            h(c, d);
            ...
            function (w) {
                ...
                if (null === w || w === q || r) {
                    ...
                    for (p = e.length; n < p; n++)
                        for (g = e[n], t = 0; t < k; t++)
                            (v = { row: g, column: t }), r ? ((x = d[g]), w(v, T(a, g, t), x.anCells ? x.anCells[t] : null) && m.push(v)) : m.push(v);
                    return m;
                }
    ...
    J("columns().search()", "column().search()", function (a, b, c, d) {
        return this.iterator("column", function (e, h) {
            ...
            e.oFeatures.bFilter &&
                (l.extend(f[h], { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }),
