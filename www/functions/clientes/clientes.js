...
function verPerfilCliente(ID) {
    ...
    $.ajax({
        method: "POST",
        dataType: "JSON",
        url: url + "Brummy/views/clientes/obtenerCliente.php",
        data: { ID },
    })
...
function guardarCliente() {
    ...
    if (valido) {
        ...
        $.ajax({
            method: "POST",
            dataType: "JSON",
            url: url + "Brummy/views/clientes/guardaCliente.php",
            data: {
                nombre,
                apellidoP,
                apellidoM,
...
function actualizarCliente(ID) {
    ...
    if (valido) {
        ...
        let indicadorCliente = $("#indicadorModal").val();
        ...
        $.ajax({
            method: "POST",
            dataType: "JSON",
            url: url + "Brummy/views/clientes/actualizaCliente.php",
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                $.ajax({
                    method: "POST",
                    dataType: "JSON",
                    url: url + "Brummy/views/clientes/eliminarCliente.php",
                    data: { ID },
                })
                    .done(function (results) {
                        let success = results.success;
...
function HistorialCliente(ID) {
    ...
    $.ajax({
        method: "POST",
        dataType: "JSON",
        url: url + "Brummy/views/clientes/traerHistorialCliente.php",
        data: { ID },
    })
        .done(function (results) {
            let success = results.success;
                            ...
                            if (data.FK_modulo == 4) {
                                ...
                                <div class="timeline-item-content">
                                    <div class="timeline-item-inner">
                                        ...
                                        <button class="button button-outline button-round btnGreen" onclick="verDetalleVentaCliente(${
                                            data.FK_registro_accion
                                        }, ${data.cambioVenta})" style="margin: 10px auto;">
                                            <span class="material-icons iconBtn" style="margin-left: 0;"> visibility </span>
                                        </button>
                                    </div>
                                </div>
